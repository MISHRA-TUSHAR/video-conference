...
import 'package:video_call_app/components/dialog_boxes/password_changed_successfully.dart';
import 'package:video_call_app/components/progress_indicator/progress_indicator.dart';
import 'package:video_call_app/controllers/reset_password_screen_controller.dart';
                            ...
                            children: [
                              if (controller.isUserAlreadyLoggedIn.value)
                                SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    style: GoogleFonts.urbanist(),
                                    validator: (value) =>
                                        controller.validator(value, 'old-pass'),
                                  ),
                                ),
                              SizedBox(
                                height: 16.h,
                              ...
                              SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  style: GoogleFonts.urbanist(),
                                  validator: (value) =>
                                      controller.validator(value, 'new-pass'),
                                ),
                              ),
                              SizedBox(
                                height: 16.h,
                              ...
                              SizedBox(
                                ...
                                child: TextFormField(
                                  controller: controller
                                      .confrimNewPasswordController.value,
                                  keyboardType: TextInputType.text,
                                  obscureText:
                                  ...
                                  decoration: InputDecoration(
                                      ...
                                      suffixIcon: IconButton(
                                          ...
                                          icon: Icon(controller
                                                  .hideConfirmNewPassword.value
                                              ? Icons.remove_red_eye_outlined
                                              : Icons
                                                  .remove_moderator_outlined))),
                                  style: GoogleFonts.urbanist(),
                                  validator: (value) => controller.validator(
                                      value, 'confirm-new-pass'),
                                ),
                              ),
                            ],
                          ),
                        ...
                        ? () async {
                            ...
                            if (result) {
                              try {
                                if (controller.isUserAlreadyLoggedIn.value) {
                                  await controller
                                      .submitResetPasswordForLoggedInUser();
                                } else {
                                  await controller
                                      .submitResetPasswordForNotLoggedInUser();
                                }
                                showPasswordChangedSuccessfullyDialogBox(
                                    context);
                              } catch (e) {
