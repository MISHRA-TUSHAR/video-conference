...
import 'package:video_call_app/controllers/sign_up_controller.dart';
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: (value) =>
                                        controller.validator(value, 'email'),
                                    style: GoogleFonts.urbanist(),
                                  ),
                                ),
                                Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    validator: (value) =>
                                        controller.validator(value, 'password'),
                                    style: GoogleFonts.urbanist(),
                                  ),
                                ),
                                Container(
                                ...
                                Container(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      prefixIcon: CountryCodePicker(
                                        ...
                                        onChanged: (pickedCountry) {
                                          controller
                                              .updateCountryInfo(pickedCountry);
                                        },
                                    ...
                                    style: GoogleFonts.urbanist(),
                                    validator: (value) =>
                                        controller.validator(value, 'phone'),
                                  ),
                                ),
                                DropdownButtonHideUnderline(
                                  child: DropdownButtonFormField(
                                    ...
                                    style: GoogleFonts.urbanist(
                                        ...
                                        fontSize: 16.sp),
                                    validator: (value) =>
                                        controller.validator(value, 'gender'),
                                  ),
                                ),
                                SizedBox(
                                  height: 10.h,
                                ...
                                Container(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      Checkbox(
                                        value:
                                            controller.isTermsAreAccepted.value,
                                        onChanged: (value) {
                    ...
                    child: ElevatedButton(
                      onPressed: !controller.isLoading.value
                          ? () async {
                              ...
                              if (!result) {
                                MyCustomToast.showErrorToast(
                                    'Invalid data provided');
                                return;
                              }

                              final isTermsAreAccepted =
                                  controller.validateTermsAndConditions();
                              if (!isTermsAreAccepted) {
                                MyCustomToast.showErrorToast(
                                    'Please select Terms and Condition checkbox');
                                return;
                              }
                              try {
                                final result = await controller.signUpUser();
                                if (result['statusCode'] == 201) {
                                  showAccountCreatedSuccessfullyDialogBox(
                                      context);
                                }
                              } catch (e) {
