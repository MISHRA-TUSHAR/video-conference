...
import 'package:video_call_app/components/progress_indicator/progress_indicator.dart';
import 'package:video_call_app/controllers/verify_otp_screen_controller.dart';
import 'package:video_call_app/screens/home_screen/home_screen.dart';
import 'package:video_call_app/screens/sign_in_screen/sign_in_screen.dart';
                          ...
                          child: ElevatedButton(
                            ...
                            style: ElevatedButton.styleFrom(
                                ...
                                side: const BorderSide(
                                    color: AppColors.royalBlueColor, width: 1),
  ...
  Widget build(BuildContext context) {
    return GetBuilder<VerifyOTPScreenController>(
      builder: (controller) => Container(
        ...
        child: !controller.isResendOTPBtnPressed.value
            ? Row(
                mainAxisAlignment: MainAxisAlignment.center,
                crossAxisAlignment: CrossAxisAlignment.center,
                children: [
                  Text(
                    '00:${controller.timerSeconds.value == 0 ? '00' : controller.timerSeconds.value}',
                    style: GoogleFonts.urbanist(
                        fontSize: 16.sp, color: AppColors.greyShade2Color),
                  ),
                  TextButton(
                    onPressed: controller.isResendBtnActive.value
                        ? () async {
                    ...
                    child: Text(
                      ...
                      style: GoogleFonts.urbanist(
                          fontSize: 16.sp,
                          color: controller.isResendBtnActive.value
                              ? AppColors.royalBlueColor
