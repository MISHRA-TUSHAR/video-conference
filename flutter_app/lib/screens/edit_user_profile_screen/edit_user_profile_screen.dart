...
import 'package:video_call_app/components/dialog_boxes/upload_user_image_dialog.dart';
import 'package:video_call_app/components/progress_indicator/progress_indicator.dart';
import 'package:video_call_app/controllers/edit_profile_screen_controller.dart';
import 'package:video_call_app/screens/menu_screen/menu_screen.dart';
                          ...
                          if (userCont.user.value?.userProfileImage != '') {
                            return CircleAvatar(
                              backgroundImage: NetworkImage(
                                  userCont.user.value!.userProfileImage),
                              radius: 50.w,
                            );
                          }
                          ...
                          children: [
                            Container(
                              ...
                              child: TextFormField(
                                ...
                                style: GoogleFonts.urbanist(),
                                validator: (value) =>
                                    controller.validator(value, 'full-name'),
                              ),
                            ),
                            Container(
                              margin: EdgeInsets.only(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  prefixIcon: CountryCodePicker(
                                    ...
                                    initialSelection: controller
                                        .initialDialCodeSelection.value,
                                    // favorite: ['+39','FR'],
                      ...
                      Container(
                        ...
                        child: ElevatedButton(
                          ...
                          style: ElevatedButton.styleFrom(
                              ...
                              fixedSize:
                                  Size.fromWidth(Get.mediaQuery.size.width),
