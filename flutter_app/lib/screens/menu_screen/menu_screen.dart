...
import 'package:video_call_app/screens/edit_user_profile_screen/edit_user_profile_screen.dart';
import 'package:video_call_app/screens/forgot_password_screen/forgot_password_screen.dart';
              ...
              child: Column(
                ...
                children: [
                      ...
                      if (controller.user.value?.userProfileImage != '') {
                        return CircleAvatar(
                          backgroundImage: NetworkImage(
                              controller.user.value!.userProfileImage),
                          radius: 50.w,
                        );
                      }
                  ...
                  GetBuilder<UserController>(
                    builder: (controller) {
                      return Text(
                        controller.user.value!.userFullName,
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        margin: EdgeInsets.only(
                            left: 20.w, right: 20.w, bottom: 19.h),
                        ...
                        decoration: BoxDecoration(
                          ...
                          border: Border.all(
                              color: AppColors.greyShade3Color, width: 1),
                        ),
                        child: Row(
