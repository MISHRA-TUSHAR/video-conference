...
class EditProfileScreenController extends GetxController {
  ...
  Future<void> saveProfile() async {
    ...
    String userPhoneNumberWithDialCode =
        '${countryInformation['dial-code'] == '' ? initialDialCodeSelection.value : countryInformation['dial-code']} $phoneNumber';
    ...
    final Map<String, dynamic> result =
        await UserServices.updateUserAccount(accInformation);
