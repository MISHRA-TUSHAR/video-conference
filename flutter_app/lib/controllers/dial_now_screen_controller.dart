...
import 'package:video_call_app/screens/admin_approval_screen/admin_approval_screen.dart';
...
class DialNowScreenController extends GetxController {
  ...
  Future<void> makeACall() async {
    ...
    String userPhoneNumberWithDialCode =
        '${countryInformation['dial-code']} $phoneNumber';
    ...
    try {
      ...
      final response =
          await UserServices.makeACall(userPhoneNumberWithDialCode);
