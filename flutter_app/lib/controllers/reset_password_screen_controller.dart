...
class ResetPasswordScreenController extends GetxController {
  ...
  Rx<TextEditingController> confrimNewPasswordController =
  ...
  Future<void> submitResetPasswordForNotLoggedInUser() async {
    ...
    final response = await UserServices.requestPasswordChangeForNotLoggedInUser(
        details: details);
  ...
  Future<void> submitResetPasswordForLoggedInUser() async {
    ...
    final response = await UserServices.requestPasswordChangeForLoggedInUser(
        details: details);
