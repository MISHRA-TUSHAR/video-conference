...
import 'package:video_call_app/screens/video_call_screen/video_call_screen_reciever.dart';
...
class IncommingCallDialogBox extends StatelessWidget {
  ...
  const IncommingCallDialogBox(
      {super.key,
      required this.roomId,
      required this.adminSocketId,
                    ...
                    child: ElevatedButton(
                      onPressed: () async {
                        ...
                        socket.emit('room:join2',
                            {"roomId": roomId, "email": userEmail});

                        Get.offAll(() => VideoCallScreenReciever(
