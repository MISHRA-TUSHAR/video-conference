...
import 'package:video_call_app/components/dialog_boxes/incommin_call_dialog.dart';
...
class SignalingService {
  ...
  init({required String webSocketUrl}) {
    ...
    socket!.on('notifyUser:call', (data) {
      ...
      Get.dialog(
        IncommingCallDialogBox(
            roomId: roomId, adminSocketId: adminSocketId, userName: userName),
